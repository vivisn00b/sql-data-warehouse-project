...
Script Purpose:
    ...
    - Use this script to redefine the DDL structure of bronze tables.

Learning Notes:
    - OBJECT_ID('schema.table', 'U') checks if a table exists ('U' = user table).
    - DROP TABLE removes the table if it exists.
    - GO signals the end of a batch; required for CREATE TABLE statements.
===============================================================================
*/
